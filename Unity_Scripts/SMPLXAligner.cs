...
public class SMPLXAligner : MonoBehaviour
{
    ...
    public Vector3 manualOffset = new Vector3(0.08f, -1.55f, 0.16f); // Ajusta estos valores según sea necesario
    ...
    void AlignWithCamera(GameObject smplxInstance, SMPLXParams parames)
    {
        ...
        Quaternion worldRotation = Quaternion.Euler(parames.rotationV.x, 
                                                    ...
                                                    -parames.rotationV.z + 180f);
        //Quaternion worldRotation = Quaternion.Euler(parames.rotationV * Mathf.Rad2Deg);
